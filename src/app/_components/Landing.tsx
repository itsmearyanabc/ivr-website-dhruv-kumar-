  ...
  return (
    <main className="landing-page">
      ...
      {waNumber && (
        ...
        >
          {/* The official WhatsApp mark. The previous path drew the speech bubble as one
              solid shape with the handset filled on top of it, so at 32px it read as a white
              blob rather than a logo. This is the real glyph: the bubble is an outline and
              the handset sits inside it, which is what makes it recognisable at this size. */}
